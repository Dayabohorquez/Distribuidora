...
const ProductPage = () => {
    ...
    const products = [
        ...
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa4 },
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa5 },
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa6 },
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa7 },
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa8 },
        { id: 'product3', name: 'Nombre del Producto 3', price: 47000, type: 'Tropicales', occasion: 'Cumpleaños', imgSrc: Chirosa9 },
                        ...
                        <ul>
                            <li>
                                <a href="detalle_producto.html" className="filter1">
                                    <img src={Chirosa1} alt="Arreglo floral Lirios de Amor" className="Ramo1" />
                                    Arreglo floral Lirios de Amor - $350,000
                                </a>
                                <a href="detalle_producto.html" className="filter1">
                                    <img src={Chirosa2} alt="Arreglo floral Lirios de Amor" className="Ramo1" />
                                    Arreglo floral Lirios de Amor - $350,000
                                </a>
                                <a href="detalle_producto.html" className="filter1">
                                    <img src={Chirosa3} alt="Arreglo floral Lirios de Amor" className="Ramo1" />
                                    Arreglo floral Lirios de Amor - $350,000
                                </a>
                            </li>
